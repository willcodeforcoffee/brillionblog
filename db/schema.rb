...
ActiveRecord::Schema[8.1].define(version: 2026_08_22_171416) do
  ...
  create_table "activity_feed_inboxes", force: :cascade do |t|
    t.string "body"
    t.datetime "created_at", null: false
    t.string "digest"
    t.string "signature"
    t.boolean "signature_checked"
    t.boolean "signature_valid"
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["user_id"], name: "index_activity_feed_inboxes_on_user_id"
  end
  ...
  create_table "post_authors", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["post_id", "user_id"], name: "index_post_authors_on_post_id_and_user_id", unique: true
  ...
  add_foreign_key "activity_feed_inboxes", "users"
